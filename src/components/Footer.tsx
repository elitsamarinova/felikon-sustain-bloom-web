        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Pioneering sustainable energy solutions and monetization opportunities in Bulgaria and across Europe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#rec" className="text-gray-600 hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">info@felikon.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-primary mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
